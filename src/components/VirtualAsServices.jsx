...
export class VirtualAsServices extends React.Component{
    render() {
        return (
                ...
                <div className="container">
                    ...
                    <div className="row d-flex">
                        ...
                        <div className="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
                            <div className="media block-6 services d-block text-center">
                                <div className="icon d-flex justify-content-center align-items-center"><span
                                    className="flaticon-call-center">
                                </span>
                                </div>
                                <div className="media-body py-md-4">
